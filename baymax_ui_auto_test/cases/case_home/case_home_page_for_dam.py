...
class HomePageTest_Dam(ParametrizedTestCase):
    def login(self):
    ...
    @classmethod
    def setUpClass(cls):
        super(HomePageTest_Dam, cls).setUpClass()

    @classmethod
    def tearDownClass(cls):
        super(HomePageTest_Dam, cls).tearDownClass()


class HomePageTest_Dam_SSSS(ParametrizedTestCase):
    def login(self):
    ...
    @classmethod
    def setUpClass(cls):
        super(HomePageTest_Dam_SSSS, cls).setUpClass()

    @classmethod
    def tearDownClass(cls):
        super(HomePageTest_Dam_SSSS, cls).tearDownClass()