...
class HomePageTest_Shubo(ParametrizedTestCase):
    def login(self):
    ...
    @classmethod
    def setUpClass(cls):
        super(HomePageTest_Shubo, cls).setUpClass()

    @classmethod
    def tearDownClass(cls):
        super(HomePageTest_Shubo, cls).tearDownClass()


class HomePageTest_Shubo_SSSS(ParametrizedTestCase):
    def login(self):
    ...
    @classmethod
    def setUpClass(cls):
        super(HomePageTest_Shubo_SSSS, cls).setUpClass()

    @classmethod
    def tearDownClass(cls):
        super(HomePageTest_Shubo_SSSS, cls).tearDownClass()